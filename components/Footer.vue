        ...
        <div class="max-w-[1200px] mx-auto px-4">
            ...
            <div class="md:flex gap-4 justify-between w-full">
                ...
                <div class="md:w-[50%] pt-4">
                    ...
                    <div class="text-[#999999] text-sm">Ukrainian, Portuguese, Spanish, French, German, Italian, Dutch, Turkish, Japanese, Korean, Thai, Vietnamese, Arabic, Hebrew, Polish</div>
                </div>
            </div>
